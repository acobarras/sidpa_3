...
define('DECIMALES', '2');
define('MONEDA', '$');
define('CORREO_JEFE_PRODUCCION', 'jefe.produccion@acobarras.com'); //CORREO DE JEFE PRODUCCION
define('CORREO_AUXI_PRODUCCION', 'produccionflexo@acobarras.com'); //CORREO DE AUXILIAR PRODUCCION