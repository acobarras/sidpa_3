                ...
                ?>
                    ...
                    <div class="tab-pane fade <?= $activa1 ?>" id="<?= $id_item1 ?>" role="tabpanel" aria-labelledby="home<?= $id_item1 ?>-tab">
                        ...
                        <div class="mb-3 text-center">
                            <h1 class="text-center">Trabajos Maquina <?= ucwords(strtolower($mq_pro->nombre_maquina)) ?></h1>
                        </div>
                        <br>
                        <table id="tabla_maquina_embobinado<?= $mq_pro->id_maquina ?>" class="table table-bordered table-responsive table-hover" cellspacing="0" width="100%">
                            <thead style="background: #002b5f;color: white">
                                <tr>
                                    <th>Fecha Compromiso</th>
                                    <th>Fecha Embobinado</th>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row">
                    <div class="col-6">
                        ...
                        <select id="maquina_embobinado" class="form-control select_2 turno_maquina" style="width: 100%">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control datepicker turno_maquina" id="fecha_embobinado_data">
                </div>
