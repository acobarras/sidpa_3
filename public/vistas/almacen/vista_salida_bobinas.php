<div class="container-fluid mt-3 mb-3">
        ...
        <div id="contenido" class="px-2 py-2 col-lg-12">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Salida Bobinas</a>
                </li>
            </ul>
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="panel panel-primary" style="margin-top: 20px;box-shadow: -4px 4px 4px -4px rgba(0,0,0,0.75); ">
                        <div class="panel-heading header_aco">
                            <center>
                                <h3 class="col-md-12 col-md-offset-4 text-center">Salida De Mercancía Bobinas</h3>
                            </center>
                        </div>
                        <br>
                        <div class="container">
                            <form id="bobina">
                                ...
                                <div class="mb-3 row">
                                    <label class="col-sm-2 col-form-ablel fw-bold">Codigo Bobina:</label>
                                    <div class="col-sm-10">
                                        <input class="form-control col-8" type="text" name="codigo_producto" id="codigo_producto_bob">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control col-8 solo-numeros" type="text" name="ancho" id="ancho">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="metros" class="col-sm-2 col-form-ablel fw-bold">Metros Lineales:</label>
                                    <div class="col-sm-10">
                                        <input class="form-control solo-numeros col-8" type="text" name="metros" id="metro_lineales">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="salida" class="col-sm-2 col-form-ablel fw-bold">Metros Cuadrados:</label>
                                    <div class="col-sm-10">
                                        <input class="form-control col-8" type="text" name="salida" id="m2" readonly>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-sm-2 col-form-ablel fw-bold">Descripcion:</label>
                                    <span class="col-sm-10 fw-bold text-primary" id="respuesta"></span>
                                </div>
                                <div class="mb-3 row">
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-primary" id="btn_ingresar_bobi" data-valida="">
    ...
    <script src="<?= PUBLICO ?>/vistas/almacen/js/vista_salida_bobinas.js"></script>