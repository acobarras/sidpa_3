        ...
        <div id="contenido" class="px-2 py-2 col-lg-12">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Salida Tecnologia</a>
                </li>
            </ul>
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="panel panel-primary" style="margin-top: 20px;box-shadow: -4px 4px 4px -4px rgba(0,0,0,0.75); ">
                        <div class="panel-heading header_aco">
                            <center>
                                <h3 class="col-md-12 col-md-offset-4 text-center">Salida De Mercancía Tecnología</h3>
                            </center>
                        </div>
                        <br />
                        <div class="container">
                            <form id="tecnologia">
                                ...
                                <div class="mb-3 row">
                                    <label for="codigo_producto" class="col-sm-2 col-form-ablel fw-bold">Numero de parte:</label>
                                    <div class="col-sm-10">
                                        <input class="form-control col-8" type="text" name="codigo_producto" id="codigo_producto_tec">
                                        <input type="hidden" name="id_productos" id="id_producto_tec">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <span class="col-sm-10  fw-bold text-primary" id="respuesta_tec"></span>
                                </div>
                                <div class="mb-3 row">
...
<script src="<?= PUBLICO ?>/vistas/almacen/js/vista_salida_tecnologia.js"></script>