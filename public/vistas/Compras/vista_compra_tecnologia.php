    ...
    <div class="recuadro">
        <div id="contenido" class="px-2 py-2 col-lg-12">
            ...
            <div class="tab-content" id="myTabContent">
                <!-- Primer link -->
                <div class="tab-pane fade show active" id="Materia_primaop" role="tabpanel" aria-labelledby="tecnologia-tab">
                    <br>
                    <div class="container-fluid recuadro">
                        <br>
                        <h3 class="text-center fw-bold">Tecnología pendiente</h3>
                        <br>

                        <div class="tb_compra_tecnologia">
                            <table id="dt_compra_tecnologia" style="background: white" class="table table-bordered 
                            ...
                            <div class="container recuadro">
                                <br>
                                <form id="form_asigna_fecha_entrega_tec">
                                <div class="mb-3">
                                    ...
                                    <center>
                                        <button type="submit" class="btn btn-info" id="asigna_material_tec"><i class="fas fa-check"></i> Asigna</button>
                                    </center>
                                </form>
                                <br>
                            </div>
...
<script src="<?= PUBLICO ?>/vistas/Compras/js/tecnologia.js"></script>
