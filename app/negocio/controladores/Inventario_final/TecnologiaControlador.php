...
class TecnologiaControlador extends GenericoControlador
{
    ...
    public function vista_inventario_final_tecnologia()
    {
        parent::cabecera();
        $this->view(
            'inventario_final/vista_inventario_final_tecnologia',
            [
                "ubicaciones_tec" => $this->ubicacionesDAO->tipo_producto_ubicaciones(3)
            ]
        );
    }
}
