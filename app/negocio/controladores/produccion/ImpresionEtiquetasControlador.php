...
class ImpresionEtiquetasControlador extends GenericoControlador
{
    ...
    {
        $this->view('produccion/impresion_etiquetas_marcacion');
    }

    public function etiqueta_sin_logo($data_item, $porciones_cod, $formulario, $nombre1, $nombre2, $operario)
    {
        $sin_logo = "
        ^XA
        ^MMT
    ...
    public function etiqueta_con_logo($data_item, $porciones_cod, $formulario, $nombre1, $nombre2, $operario)
    {
        $imagen = "
